        ...
        <div className="p-4 flex flex-col h-full">
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              <span className="font-extrabold text-[22px] tracking-wide text-green-600 drop-shadow-[0_0_10px_rgba(22,163,74,0.4)] leading-none mb-1">AgroAI</span>
              <span className="text-[9px] font-bold text-emerald-500 tracking-[0.22em] ml-0.5 uppercase leading-none drop-shadow-sm">Smart Farming</span>
            </div>
          </button>
              ...
              <div className="p-4 flex flex-col h-full">
                <div className="flex items-center justify-between mb-4 mt-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex flex-col justify-center">
                      <span className="font-extrabold text-[19px] tracking-wide text-green-600 drop-shadow-[0_0_10px_rgba(22,163,74,0.4)] leading-none mb-1">AgroAI</span>
                      <span className="text-[8px] font-bold text-emerald-500 tracking-[0.22em] ml-0.5 uppercase leading-none drop-shadow-sm">Smart Farming</span>
                    </div>
                  </div>
                  <button
                    onClick={() => setIsMobileMenuOpen(false)}
